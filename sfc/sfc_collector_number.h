...
#define SFC_COLLECTOR_NUMBER(_x)				(((_x) & SFC_COLLECTOR_NUMBER_BIT_MASK) >> SFC_COLLECTOR_NUMBER_BIT_OFFSET)
#define SFC_COLLECTOR_NUMBER_VERSION(_x)		(((_x) & SFC_COLLECTOR_NUMBER_VERSION_BIT_MASK) >> SFC_COLLECTOR_NUMBER_VERSION_BIT_OFFSET)
